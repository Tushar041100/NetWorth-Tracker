...
X = df[[
    'age', 'income_per_month', 'monthly_expenses',
    'goal_horizon_years', 'risk_tolerance', 'financial_goal',
    'investment_experience', 'savings_ratio', 'is_long_term_goal',
    'income_bracket'
]]
y = df[[
    'equity_percent', 'debt_percent',
    'gold_percent', 'real_estate_percent'
]]
 
# Normalize numerical features
scaler = StandardScaler()
X[['age', 'income_per_month', 'monthly_expenses', 'goal_horizon_years']] = \
    scaler.fit_transform(X[['age', 'income_per_month', 'monthly_expenses', 'goal_horizon_years']])
